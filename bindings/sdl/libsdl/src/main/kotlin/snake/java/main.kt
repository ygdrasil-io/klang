...
import io.github.libsdl4j.api.error.SdlError.SDL_GetError
import io.github.libsdl4j.api.event.SDL_Event
import io.github.libsdl4j.api.event.SDL_EventType
import io.github.libsdl4j.api.event.SdlEvents.SDL_PollEvent
import io.github.libsdl4j.api.pixels.SdlPixelsConst.SDL_ALPHA_OPAQUE
import io.github.libsdl4j.api.rect.SDL_Rect
import io.github.libsdl4j.api.render.SDL_Renderer
import io.github.libsdl4j.api.render.*
import io.github.libsdl4j.api.render.SdlRender.*
import io.github.libsdl4j.api.render.SdlRender.SDL_DestroyTexture
import io.github.libsdl4j.api.rwops.SdlRWops.SDL_RWFromFile
import io.github.libsdl4j.api.scancode.SDL_Scancode
import io.github.libsdl4j.api.surface.SdlSurface.SDL_LoadBMP_RW
import io.github.libsdl4j.api.timer.SdlTimer.SDL_Delay
import io.github.libsdl4j.api.video.SDL_Window
import io.github.libsdl4j.api.video.SDL_WindowFlags
import io.github.libsdl4j.api.video.SdlVideo.SDL_CreateWindow
import io.github.libsdl4j.api.video.SdlVideo.SDL_DestroyWindow
import java.io.File
...
class SdlUI(width: Int, height: Int): AutoCloseable {
	...
	fun draw(game: Game) {
		...
		SDL_SetRenderDrawColor(renderer, (200 / 2).toByte(), (230 / 2).toByte(), (151 / 2).toByte(), SDL_ALPHA_OPAQUE.toByte())
	...
	companion object {
		fun SDL_Renderer.loadTexture(fileName: String): SDL_Texture {
			...
			val bmp = SDL_LoadBMP_RW(SDL_RWFromFile(filePath, "rb"), 1)

			return SDL_CreateTextureFromSurface(this@loadTexture, bmp)
		}
	...
	override fun close() {
		...
		SDL_DestroyTexture(sprites.grassTexture)
