...
public class IndexTest extends ClangTest {
    ...
    public void testStartedTranslationUnit() {
        ...
        indexTestDeclarations(new AbstractIndexerCallback() {
            ...
            public void startedTranslationUnit() {
                Assertions.assertFalse(started[0]);
                started[0] = true;
            }
        });
        Assertions.assertTrue(started[0]);
    }
    ...
    public void testEnteredMainFile() {
        ...
        Assertions.assertNotNull(handle[0]);
        Assertions.assertEquals(new File(getTestDeclarationsFile()).getAbsoluteFile(), handle[0].getAbsoluteFile());
    }
    ...
    public void testIndexDeclaration() {
        ...
        out.close();
        TestUtils.createOrCompare(sw.toString(), getDir() + "indexDeclaration.txt");
    }
    ...
    public void testIndexObjCAttributes() {
        ...
        out.close();
        TestUtils.createOrCompare(sw.toString(), getDir() + "objcAttributes.txt");
    }
    ...
    public void testIndexContainerInfo() {
        ...
        out.close();
        TestUtils.createOrCompare(sw.toString(), getDir() + "containerInfo.txt");
    }
}
